...
def bolt_calculator(n,bolt_size, Second_level, grade, MEOP, dcasing, ocasing,E_dist,E_dist_2, Material):
    ...
    if Material == "Alu":
        ...
        TYS = 270 #Tensile Yield strength of the casing in Mpa
...
grade = 8.8 #Bolt Grade
MEOP =  60 #the maximum expected operating pressure in bar
dcasing = 120.7 #inner casing diameter in mm
ocasing = 127 #outer casing diameter in mm
E_dist = 20 #Distance between center of bolt and edge of tank in mm
E_dist_2 = 40 #Distance for second level between center of bolt and edge of tank in mm
